...
# This file is part of nautilus-dropbox 2024.01.22.
#
...
def download_file_chunk(url, buf):
    ...
    opener.addheaders = [('User-Agent', "DropboxLinuxDownloader/2024.01.22")]
...
it's installed, and the Dropbox command-line interface.
    ...
    console_print("Dropbox command-line interface version: 2024.01.22")
